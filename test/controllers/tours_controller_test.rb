...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { end: @tour.end, guide_id: @tour.guide_id, location: @tour.location, price: @tour.price, start: @tour.start, user_id: @tour.user_id } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { end: @tour.end, guide_id: @tour.guide_id, location: @tour.location, price: @tour.price, start: @tour.start, user_id: @tour.user_id } }
