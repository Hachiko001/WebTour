...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post guides_url, params: { guide: { address: @guide.address, date: @guide.date, email: @guide.email, image: @guide.image, language: @guide.language, name: @guide.name, password: @guide.password, rating: @guide.rating } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { address: @guide.address, date: @guide.date, email: @guide.email, image: @guide.image, language: @guide.language, name: @guide.name, password: @guide.password, rating: @guide.rating } }
